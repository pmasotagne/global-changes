export const REQUIRED_COLUMN_HEADERS = [
    ['MMS ID', 'Holding ID', 'Physical ID','delimiter'],
    ['Barcode','delimiter']
  ];
  
export const ALLOWED_COLUMN_COUNTS = [2, 4];
...
export const positionOptions: Position[] = [
    { value: 'front', label: 'moveFieldItems.position.front' },
    { value: 'back', label: 'moveFieldItems.position.back' },
    { value: 'overwrite', label: 'moveFieldItems.position.overwrite' }
];
...
export const delimiterOptions: Delimiter[] = [
    { value: '.', label: 'moveFieldItems.delimiter.point' },
    { value: '#', label: 'moveFieldItems.delimiter.hash' },
    { value: '@', label: 'moveFieldItems.delimiter.at' },
    { value: '|', label: 'moveFieldItems.delimiter.pipe' },
    { value: '/', label: 'moveFieldItems.delimiter.slash' },
    { value: '\\', label: 'moveFieldItems.delimiter.backslash' },
    { value: '-', label: 'moveFieldItems.delimiter.hyphen' },
    { value: '--', label: 'moveFieldItems.delimiter.doubleHyphen' }
];